...
export const Room = {
	"struct": {
		"#cumulativeEnergyHarvested": { "member": "int32", "offset": 0x34 },
		"#invaderEnergyTarget": { "member": "int32", "offset": 0x3c },
		"#level": { "member": "int32", "offset": 0x40 },
		"#safeModeUntil": { "member": "int32", "offset": 0x48 },
		"name": { "member": "string", "offset": 0x2c },
		"#eventLog": {
			"offset": 0x38,
			"member": {
				"align": 4,
				...
				"list": {
					"variant": [ {
						...
						"layout": {
							"variant": 5,
							"struct": {
								"amount": { "member": "int32", "offset": 0x20 },
								"objectId": { "member": Id, "offset": 0x0 },
								"targetId": { "member": Id, "offset": 0x10 },
								"event": {
									"member": { "constant": 5 },
									"offset": 0x24,
								},
						...
						"layout": {
							"variant": 1,
							"struct": {
								"attackType": { "member": "int32", "offset": 0x20 },
								"damage": { "member": "int32", "offset": 0x24 },
								"objectId": { "member": Id, "offset": 0x0 },
								"targetId": { "member": Id, "offset": 0x10 },
								"event": {
									"member": { "constant": 1 },
						...
						"layout": {
							...
							"struct": {
								"amount": { "member": "int32", "offset": 0x20 },
								"healType": { "member": "int32", "offset": 0x24 },
								"objectId": { "member": Id, "offset": 0x0 },
								"targetId": { "member": Id, "offset": 0x10 },
								"event": {
									"member": { "constant": 6 },
						...
						"layout": {
							"variant": 4,
							"struct": {
								"amount": { "member": "int32", "offset": 0x10 },
								"energySpent": { "member": "int32", "offset": 0x14 },
								"targetId": { "member": Id, "offset": 0x0 },
								"event": {
									"member": { "constant": 4 },
									"offset": 0x18,
								},
						...
						"layout": {
							...
							"struct": {
								"amount": { "member": "int32", "offset": 0x20 },
								"energySpent": { "member": "int32", "offset": 0x24 },
								"objectId": { "member": Id, "offset": 0x0 },
								"targetId": { "member": Id, "offset": 0x10 },
								"event": {
									"member": { "constant": 7 },
					...
					"memory": {
						...
						"member": {
							...
							"list": {
								"struct": {
									"id": { "member": Id, "offset": 0x0 },
									"memory": { "member": "buffer", "offset": 0x10 },
								},
							},
						},
					},
					"users": {
						"member": { "align": 4, "size": 16, "stride": 16, "vector": Id },
						"offset": 0x0,
					},
				},
			},
		...
		"#objects": {
			"member": { "align": 4, "list": AnyObject, "size": 5 },
			"offset": 0x44,
		},
		"#sign": {
			"offset": 0x4c,
			"member": {
				...
				"pointer": {
					"struct": {
						"datetime": { "member": "double", "offset": 0x10 },
						"text": { "member": "string", "offset": 0x18 },
						"time": { "member": "int32", "offset": 0x20 },
						"userId": { "member": Id, "offset": 0x0 },
					},
				},
			},
		},
		"#user": {
			"member": { "align": 4, "pointer": Id, "size": 16 },
			"offset": 0x50,
		},
		"#users": {
			"offset": 0x0,
