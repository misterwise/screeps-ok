...
- Plan: bid 0 instead of 1 for the power creep's own move, which takes the pairing out of the random tie-break entirely. Self-contained one-liner; worth an upstream PR.
