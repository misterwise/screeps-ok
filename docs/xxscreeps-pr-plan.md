...
Last refreshed: 2026-05-19 (pin `15df4bea`).
...
`docs/status.md` currently reports 24 expected-failure classifications: 22 open parity gaps covering 46 tests, plus 2 accepted divergences covering 4 tests.
