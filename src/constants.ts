...
export const FIND_MY_CONSTRUCTION_SITES: 114 = C.FIND_MY_CONSTRUCTION_SITES;
export const FIND_HOSTILE_CONSTRUCTION_SITES: 115 = C.FIND_HOSTILE_CONSTRUCTION_SITES;
...
export const CONTROLLER_DOWNGRADE_RESTORE: number = C.CONTROLLER_DOWNGRADE_RESTORE;
