...
export const towerAttackValidationCases = makeValidationCases('TOWER-ATTACK-005', [
...
export type TowerAttackValidationCase = typeof towerAttackValidationCases[number];
