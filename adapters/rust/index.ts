...
class RustAdapter implements ScreepsOkAdapter {
	...
	async placePowerCreep(_room: string, _spec: PowerCreepSpec): Promise<string> {
		throw new Error('placePowerCreep not supported by the rust adapter');
	}
	async placeNuke(_room: string, _spec: NukeSpec): Promise<string> {
		throw new Error('placeNuke not supported by the rust adapter');
	}
	async placeMarketOrder(_spec: MarketOrderSpec): Promise<string> {
		throw new Error('placeMarketOrder not supported by the rust adapter');
	}
